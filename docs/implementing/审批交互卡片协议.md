...
本文档定义了紫微系统中谛听审批场景的交互卡片协议，基于 T1-T3 设计方案实现审批流程的人机交互。
...
```
请求: curl -X POST http://diting:8080/api/v1/cheq/create \
...
```
请求: curl -X POST http://diting:8080/api/v1/cheq/approve \
